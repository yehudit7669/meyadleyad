...
CREATE TABLE IF NOT EXISTS email_permissions (
  ...
  CONSTRAINT check_permission_type CHECK (permission_type IN ('publish_without_approval', 'manage_branding', 'export_users', 'export_ads', 'export_stats', 'export_mailing_list', 'download_audit_log'))
);
