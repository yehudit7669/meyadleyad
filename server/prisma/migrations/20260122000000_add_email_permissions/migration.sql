-- Add email_permissions table for exceptional export permissions
...
CREATE INDEX idx_email_permissions_email ON email_permissions(email);
CREATE INDEX idx_email_permissions_active ON email_permissions(is_active);
