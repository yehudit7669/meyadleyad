/**
 * Google Forms Apps Script - אינטגרציה עם מערכת המקום (דרושה דירה לקניה)
 * 
 * הוראות התקנה:
 * 1. פתח את טופס דרושה דירה לקניה ב-Google Forms
...
const CATEGORY = 'דירות למכירה';  // שם הקטגוריה (חייב להיות בדיוק כמו בבסיס הנתונים!)
...
function buildPayload(responses) {
  ...
  if (autoTitle === 'דרושה ') autoTitle = 'דרושה דירה לקניה';
...
function testSubmission() {
  ...
  const testResponses = {
    ...
    'שם': 'שרה כהן',
    'טלפון': '054-1234567',
    'תיאור הדרוש': 'דירת 4 חדרים בירושלים עד 2.5 מיליון ₪, בשכונה שקטה עם חניה וממ"ד. מעדיפים קומה נמוכה עם מעלית.',
    'עיר': 'ירושלים',
    'שכונה': 'קטמון',
    'רחוב': '',
    'מספר בית': '',
    ...
    'וועד בית (לחודש)': '',
    'תיווך': 'לא משנה',
    'מאפיינים': ['חניה', 'ממ"ד', 'מעלית', 'מיזוג'],
