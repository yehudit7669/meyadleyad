/**
 * Google Forms Apps Script - אינטגרציה עם מערכת המקום (דירה להשכרה)
 * 
 * הוראות התקנה:
 * 1. פתח את טופס ההשכרה ב-Google Forms
...
const CATEGORY = 'דירה להשכרה';  // שם הקטגוריה (חייב להיות בדיוק כמו בבסיס הנתונים!)
