...
const FIELD_MAPPING = {
  ...
  parasha: 'פרשה',                   // שבת פרשת...
  purpose: 'מטרת האירוח',            // אירוח מלא / לינה בלבד
  priceRequested: 'מחיר מבוקש',      // מחיר (אם בתשלום)
...
function buildPayload(responses) {
  ...
  if (features) {
    ...
    if (Array.isArray(features)) {
      ...
      // לינה בלבד - מאפיין ייחודי לדירה לשבת
...
function testSubmission() {
  ...
  const testResponses = {
    ...
    'אירוח בתשלום': 'כן',
    'פרשה': 'ויקרא',
    'מטרת האירוח': 'אירוח מלא',
    'מחיר מבוקש': '2500',
    'תיווך': 'פרטי',
    'מאפיינים': ['חניה', 'מעלית', 'שעון שבת', 'מיזוג', 'ממ"ד'],
