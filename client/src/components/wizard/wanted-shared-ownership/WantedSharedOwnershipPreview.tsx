...
interface Props {
  wizardData: Partial<WantedSharedOwnershipWizardData>;
      ...
      <div className="bg-white border-2 border-gray-200 rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              {step4?.contactName && (
                <p className="text-gray-900 font-medium mb-1">👤 {step4.contactName}</p>
              )}
              <p className="text-gray-900 font-medium">📱 {step4?.contactPhone || 'לא צוין'}</p>
...
export default WantedSharedOwnershipStep6;
