...
import { SharedOwnershipStep3Data, PropertyType, PropertyCondition, sharedOwnershipStep3Schema, WizardStepProps } from '../../../types/wizard';
...
const WantedSharedOwnershipStep3: React.FC<WizardStepProps> = ({ data, onNext, onPrev }) => {
...
export default WantedSharedOwnershipStep3;
