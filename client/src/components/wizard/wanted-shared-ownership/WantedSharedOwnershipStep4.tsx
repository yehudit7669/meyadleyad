...
import { SharedOwnershipStep5Data, sharedOwnershipStep5Schema, WizardStepProps } from '../../../types/wizard';
import { useAuth } from '../../../hooks/useAuth';
import { useQuery } from '@tanstack/react-query';
import { brokerService } from '../../../services/brokerService';

const WantedSharedOwnershipStep4: React.FC<WizardStepProps> = ({ data, onNext, onPrev }) => {
  const { user } = useAuth();
...
export default WantedSharedOwnershipStep4;
