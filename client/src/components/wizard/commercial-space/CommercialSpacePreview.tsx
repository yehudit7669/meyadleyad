...
interface Props {
  wizardData: Partial<CommercialSpaceWizardData>;
  onSubmit: (sendCopyToEmail: boolean) => void;
  onPrev: () => void;
  isLoading?: boolean;
}

const CommercialSpacePreview: React.FC<Props> = ({ wizardData, onSubmit, onPrev, isLoading }) => {
...
export default CommercialSpacePreview;
