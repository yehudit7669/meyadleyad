...
export interface CommercialSpaceStep4Data {
...
const CommercialSpaceStep4: React.FC<WizardStepProps> = ({ data, onNext, onPrev }) => {
  const [formData, setFormData] = useState<CommercialSpaceStep4Data>(
    data || {
  ...
  const handleChange = (field: keyof CommercialSpaceStep4Data, value: any) => {
...
export default CommercialSpaceStep4;
