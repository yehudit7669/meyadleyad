...
export interface WantedCommercialStep6Data {
  contactName: string;
  contactPhone: string;
...
const WantedCommercialStep6: React.FC<WizardStepProps> = ({ data, onNext, onPrev }) => {
  const [formData, setFormData] = useState<WantedCommercialStep6Data>(
    data || {
      contactName: '',
      contactPhone: '',
      agreeToTerms: true,
  ...
  const handleChange = (field: keyof WantedCommercialStep6Data, value: any) => {
...
export default WantedCommercialStep6;
