...
interface SharedOwnershipStep4Data {
  description: string;
  images: PropertyImage[];
  floorPlan?: File | null;
}

const SharedOwnershipStep4: React.FC<WizardStepProps> = ({ data, onNext, onPrev }) => {
  const [formData, setFormData] = useState<SharedOwnershipStep4Data>(
    data || {
      description: '',
      images: [],
      floorPlan: null,
...
export default SharedOwnershipStep4;
