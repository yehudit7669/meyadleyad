/**
 * Google Forms Apps Script - אינטגרציה עם מערכת המקום (נדל"ן מסחרי)
 * 
 * הוראות התקנה:
 * 1. פתח את טופס נדל"ן מסחרי ב-Google Forms
...
function buildPayload(responses) {
  ...
  else if (transactionType && transactionType.includes('מכירה')) autoTitle += 'למכירה ';
  if (city) autoTitle += 'ב' + city;
  if (!autoTitle) autoTitle = 'נכס מסחרי';
...
function testSubmission() {
  ...
  const testResponses = {
    ...
    'שם': 'יוסי כהן',
    'טלפון': '050-9876543',
    'תיאור הנכס': 'משרד מרווח וממוזג במיקום מרכזי, פינת מטבחון, שירותים, חניה, גישה נוחה לתחבורה ציבורית. מושלם לעסק קטן או סטארטאפ.',
    'עיר': 'תל אביב',
    'שכונה': 'מרכז העיר',
    'רחוב': 'דיזנגוף',
    'תוספת כתובת (לדוג: דירה 14, כניסה ב\')': 'קומה 3',
    'סוג הנכס': 'משרד',
    'שטח במ"ר': '60',
    'קומה': '3',
    'ריהוט': 'ללא ריהוט',
    ...
    'תיווך ': 'ללא תיווך',
    'מאפיינים': ['מיזוג', 'מטבחון', 'שירותים', 'חניה', 'אינטרנט', 'נגישות'],
