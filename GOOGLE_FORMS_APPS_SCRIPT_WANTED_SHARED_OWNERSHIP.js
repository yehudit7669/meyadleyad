/**
 * Google Forms Apps Script - אינטגרציה עם מערכת המקום (דרושים - טאבו משותף)
 * 
 * הוראות התקנה:
 * 1. פתח את טופס דרושים - טאבו משותף ב-Google Forms
...
const FIELD_MAPPING = {
  ...
  requiredEquity: 'הון עצמי זמין',
  numberOfPartners: 'מספר שותפים מבוקש',
...
function buildPayload(responses) {
  ...
  if (autoTitle === 'דרוש ') autoTitle = 'דרוש נכס בטאבו משותף';
  ...
  // הון עצמי זמין (שדה ייחודי לטאבו משותף)
  ...
  // מספר שותפים מבוקש (שדה ייחודי לטאבו משותף)
  if (numberOfPartners) {
...
function testSubmission() {
  ...
  const testResponses = {
    ...
    'שם': 'רחל כהן',
    'טלפון': '053-9876543',
    'תיאור הדרוש': 'מחפשים נכס בטאבו משותף באזור ירושלים, 4 חדרים לפחות. יש לנו הון עצמי של 250,000 ₪ ומעוניינים ב-3 שותפים. מעדיפים נכס עם חניה ומעלית.',
    'עיר': 'ירושלים',
    'שכונה': 'קטמון',
    'רחוב': '',
    'מספר בית': '',
    ...
    'וועד בית (לחודש)': '',
    'תיווך': 'לא משנה',
    'הון עצמי זמין': '250000',
    'מספר שותפים מבוקש': '3',
    'מאפיינים': ['חניה', 'מעלית', 'מיזוג', 'ממ"ד'],
