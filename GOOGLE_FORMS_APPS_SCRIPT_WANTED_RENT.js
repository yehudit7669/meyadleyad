/**
 * Google Forms Apps Script - אינטגרציה עם מערכת המקום (דרושה דירה להשכרה)
 * 
 * הוראות התקנה:
 * 1. פתח את טופס דרושה דירה להשכרה ב-Google Forms
...
const CATEGORY = 'דירות להשכרה';  // שם הקטגוריה (חייב להיות בדיוק כמו בבסיס הנתונים!)
...
function buildPayload(responses) {
  ...
  let autoTitle = 'דרושה דירה להשכרה ';
  if (propertyType && propertyType !== 'דירה') autoTitle = 'דרושה ' + propertyType + ' להשכרה ';
...
function testSubmission() {
  ...
  const testResponses = {
    ...
    'שם': 'דניאל לוי',
    'טלפון': '052-9876543',
    'תיאור הדרוש': 'דירת 3 חדרים להשכרה בירושלים, עד 4500 ₪ לחודש. נדרשת דירה מרוהטת עם חניה, קומה נמוכה עם מעלית. כניסה מיידית.',
    'עיר': 'ירושלים',
    'שכונה': 'בקעה',
    'רחוב': '',
    'מספר בית': '',
    ...
    'וועד בית (לחודש)': '',
    'תיווך': 'לא משנה',
    'מאפיינים': ['חניה', 'מעלית', 'מיזוג', 'משופץ'],
